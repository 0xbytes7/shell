...
{
    return isset($_COOKIE['user_id']) && $_COOKIE['user_id'] === '7x1337'; 
}
...
if (is_logged_in()) {
    ...
    if (isset($_POST['password'])) {
        ...
        $hashed_key = '$2y$10$/PMkAezcpItscZS9HJ0gBeYESr01tDQ2x1fh5rTTqPyG2Li787hrq'; // https://bcrypt.online/
        
        if (password_verify($entered_key, $hashed_key)) {
            setcookie('user_id', '7x1337', time() + 3600, '/'); 
